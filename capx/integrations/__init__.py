...
from .openarm.control import OpenArmControlApi, OpenArmRecordingApi
...
def _register_openarm_apis() -> None:
    register_api("OpenArmControlApi", OpenArmControlApi)
    register_api("OpenArmRecordingApi", OpenArmRecordingApi)


def _register_franka_core_apis() -> None:
...
def _register_franka_libero_apis() -> None:
...
_register_openarm_apis()
_safe_register("Franka core APIs", _register_franka_core_apis)
_safe_register("Franka LIBERO APIs", _register_franka_libero_apis)
_safe_register("R1Pro APIs", _register_r1pro_apis)


__all__ = ["list_apis", "register_api", "OpenArmControlApi", "OpenArmRecordingApi"]
